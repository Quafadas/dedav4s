...
$c_Lviz_doc_showJsDocs$.prototype.apply__T__Lorg_scalajs_dom_Element__I__V = (function(path, node, width) {
  ...
  xhr.send();
  var text = $as_T(xhr.responseText);
  var parsed = JSON.parse(text);
  vegaEmbed.embed(("#" + anId), parsed, opts);
});
var $d_Lviz_doc_showJsDocs$ = new $TypeData().initClass($c_Lviz_doc_showJsDocs$, "viz.doc.showJsDocs$", ({
...
$c_s_util_Random.prototype.alphanumeric__sci_LazyList = (function() {
  return $m_sci_LazyList$().continually__F0__sci_LazyList(new $c_sr_AbstractFunction0_$$Lambda$a02b774b97db8234e08c6a02dd06557c99779855((() => $bC($p_s_util_Random__nextAlphaNum$1__C(this)))));
});
/** @constructor */
function $c_s_util_hashing_MurmurHash3$() {
...
mdoc_js_run0 = (function(arg) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__V("plotDensityGaussian", arg, 50);
});
mdoc_js_run1 = (function(arg) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__V("plotDensityLogNormal", arg, 50);
});
}).call(this);
