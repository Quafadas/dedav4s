...
$c_Lmdocjs$.prototype.run0__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("lineChartBadMods", node, 0)
});
$c_Lmdocjs$.prototype.run1__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("lineChartLiteWithUrl", node, 0)
});
$c_Lmdocjs$.prototype.run2__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("lineChartWithData", node, 0)
});
