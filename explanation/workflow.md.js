...
$c_Lmdocjs$.prototype.run0__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("linechart1", node, 0)
});
$c_Lmdocjs$.prototype.run1__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("pacman", node, 50)
});
