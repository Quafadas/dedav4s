...
$c_Lmdocjs$.prototype.run0__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("labelledBarChart", node, 0)
});
$c_Lmdocjs$.prototype.run1__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("unlballedBarChart", node, 0)
});
$c_Lmdocjs$.prototype.run2__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("pieChart", node, 0)
});
$c_Lmdocjs$.prototype.run3__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("pieChartLabelled", node, 0)
});
$c_Lmdocjs$.prototype.run4__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("wordcloud", node, 50)
});
$c_Lmdocjs$.prototype.run5__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("lineChart", node, 0)
});
$c_Lmdocjs$.prototype.run6__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("dotplot", node, 0)
});
$c_Lmdocjs$.prototype.run7__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("scatterPlot", node, 0)
});
$c_Lmdocjs$.prototype.run8__Lorg_scalajs_dom_HTMLElement__V = (function(node) {
  $m_Lviz_doc_showJsDocs$().apply__T__Lorg_scalajs_dom_Element__I__O("regression", node, 25)
});
...
$c_Lmdocjs$.prototype.$classData = $d_Lmdocjs$;
var $n_Lmdocjs$;
function $m_Lmdocjs$() {
  if ((!$n_Lmdocjs$)) {
...
/** @constructor */
function $c_Lviz_doc_showJsDocs$() {
  /*<skip>*/
}
$c_Lviz_doc_showJsDocs$.prototype = new $h_O();
$c_Lviz_doc_showJsDocs$.prototype.constructor = $c_Lviz_doc_showJsDocs$;
/** @constructor */
function $h_Lviz_doc_showJsDocs$() {
  /*<skip>*/
}
$h_Lviz_doc_showJsDocs$.prototype = $c_Lviz_doc_showJsDocs$.prototype;
$c_Lviz_doc_showJsDocs$.prototype.apply__T__Lorg_scalajs_dom_Element__I__O = (function(path, node, width) {
  var child = document.createElement("div");
  var this$1 = $m_s_util_Random$().alphanumeric__sci_LazyList().take__I__sci_LazyList(8);
...
var $d_Lviz_doc_showJsDocs$ = new $TypeData().initClass({
  Lviz_doc_showJsDocs$: 0
}, false, "viz.doc.showJsDocs$", {
  Lviz_doc_showJsDocs$: 1,
  O: 1
});
$c_Lviz_doc_showJsDocs$.prototype.$classData = $d_Lviz_doc_showJsDocs$;
var $n_Lviz_doc_showJsDocs$;
function $m_Lviz_doc_showJsDocs$() {
  if ((!$n_Lviz_doc_showJsDocs$)) {
...
function $p_s_util_Random__nextAlphaNum$1__C($thiz) {
  var index = $thiz.s_util_Random__f_self.nextInt__I__I($uI("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".length));
...
$c_s_util_Random.prototype.alphanumeric__sci_LazyList = (function() {
  return $m_sci_LazyList$().continually__F0__sci_LazyList(new $c_sjsr_AnonFunction0(((this$1) => (() => $bC($p_s_util_Random__nextAlphaNum$1__C(this$1))))(this)))
});
/** @constructor */
...
$c_sci_LazyList$.prototype.continually__F0__sci_LazyList = (function(elem) {
  var state = new $c_sjsr_AnonFunction0(((this$1, elem$1) => (() => {
    $m_sci_LazyList$();
    var hd = elem$1.apply__O();
    var tl = $m_sci_LazyList$().continually__F0__sci_LazyList(elem$1);
...
function $p_sci_LazyList__takeImpl__I__sci_LazyList($thiz, n) {
  if ((n <= 0)) {
    ...
    $m_sci_LazyList$();
    var state = new $c_sjsr_AnonFunction0(((this$1, n$1) => (() => {
      if (this$1.isEmpty__Z()) {
        return $m_sci_LazyList$State$Empty$()
      } else {
        $m_sci_LazyList$();
        var hd = this$1.scala$collection$immutable$LazyList$$state__sci_LazyList$State().head__O();
        var tl = $p_sci_LazyList__takeImpl__I__sci_LazyList(this$1.scala$collection$immutable$LazyList$$state__sci_LazyList$State().tail__sci_LazyList(), (((-1) + n$1) | 0));
        return new $c_sci_LazyList$State$Cons(hd, tl)
      }
    }))($thiz, n));
    return new $c_sci_LazyList(state)
...
let $e_mdoc_js_run2 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run2__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run2 as mdoc_js_run2 };
let $e_mdoc_js_run4 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run4__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run4 as mdoc_js_run4 };
let $e_mdoc_js_run8 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run8__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run8 as mdoc_js_run8 };
let $e_mdoc_js_run6 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run6__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run6 as mdoc_js_run6 };
let $e_mdoc_js_run3 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run3__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run3 as mdoc_js_run3 };
let $e_mdoc_js_run1 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run1__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run1 as mdoc_js_run1 };
let $e_mdoc_js_run5 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run5__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run5 as mdoc_js_run5 };
let $e_mdoc_js_run7 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run7__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
export { $e_mdoc_js_run7 as mdoc_js_run7 };
let $e_mdoc_js_run0 = (function(arg) {
  var prep0 = arg;
  $m_Lmdocjs$().run0__Lorg_scalajs_dom_HTMLElement__V(prep0)
});
