...
Dedav4s is a Scala 3 project using the mill build tool. It seeks to wrap vega, vega-lite and echarts plotting libraries, primarily for use in the termainal or scripting environments.
