  ...
  private def tempFileHtml(spec: String, lib: ChartLibrary): String =
    lib match
      ...
      case ChartLibrary.Echarts => raw"""
        ...
        """
      case ChartLibrary.Graph =>
        // For Graph, the spec is already complete HTML generated by SprottyExporter
        // Parse it as JSON string to extract the HTML content
        ujson.read(spec).str
